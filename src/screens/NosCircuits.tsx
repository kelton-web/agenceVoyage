...
import DATA from '../data/DataCircuits';
import { useNavigation } from "@react-navigation/native";
import { NativeStackNavigationProp } from "@react-navigation/native-stack";
import Navigation, { RouteParams } from "../navigation/Navigation";
import CardCircuit from "../components/compCircuits/CardCircuit";

interface StockCircuits {
...
const NosCircuits: React.FC<StockCircuits> = ({title, desc, img, destination, imgDestination}) => {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.containerImg}>
                <ImageBackground source={require('../../assets/circuit/vietnam.png')} style={styles.smallContainerImg}>
                    <Text style={styles.textStyle}>NOS CIRCUITS</Text>
            ...
            <View style={styles.containerDestination}>
                <ScrollView>
                    <View>
                        {DATA.map((item: StockCircuits, key: number) =>
                            <CardCircuit key={key} title={item.title} imgDestination={item.imgDestination} img={item.img} desc={item.desc} destination={item.destination} />
                        )}
                    </View>
                </ScrollView>
            </View>
