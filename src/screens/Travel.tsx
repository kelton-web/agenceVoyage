...
import CardDestination from "../components/compTravel/Destination";

interface StockTravel {
...
const Travel: React.FC<StockTravel> = ({title, desc, img, destination, imgDestination}) => {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.containerImg}>
                <ImageBackground source={require('../../assets/playa_accueil.png')} style={styles.smallContainerImg}>
            ...
            <View style={styles.containerDestination}>
                <ScrollView>
                    <View>
                        {DATA.map((item: StockTravel, key: number) =>
                            <CardDestination key={key} title={item.title} imgDestination={item.imgDestination} img={item.img} desc={item.desc} destination={item.destination} />
                        )}
                    </View>
                </ScrollView>
            </View>
